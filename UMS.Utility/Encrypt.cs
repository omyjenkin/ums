...
namespace UMS.Utility
{
    ...
    public class Encrypt
    {
        ...
        public static string MD5(string s)
        {
            ...
            byte[] bytes = md5.ComputeHash(System.Text.Encoding.UTF8.GetBytes(s.Trim()));
            ...
            for (int i = 0; i < bytes.Length; i++)
            {
                int a = 0xf & bytes[i] >> 4;
                int b = bytes[i] & 0xf;
                result.Append(md5Str.Substring(0xf & bytes[i] >> 4, 1) + md5Str[bytes[i] & 0xf]);
            }
        ...
        public static string MD5Common(string s)
        {
